...
const node_link =
	"https://eth-goerli.g.alchemy.com/v2/9GwOhX6bs6tGSM6dFVLaGIwycs0SrCmW";
...
export default function Home({ fee }) {
	...
	const {
		...
		writeAsync: startTrial,
	} = useContractWrite(trialConfig);
          ...
          <ConnectButton chainStatus="none" />
				...
				<div className="items-center align-middle justify-center flex m-auto h-screen flex-col">
					...
					<Text
						...
						weight="bold"
					>
						Track financial metrics for data driven decisions
					</Text>
					<div className="my-10">
						<Input
							{...iBindings}
				...
				>
					...
					<Modal.Body>
						{trial ? (
							<Text>
								This product costs {web3.utils.fromWei(fee)} ETH to use. You can
								begin your trial below.
							</Text>
						) : (
							<Text>
								This product costs {web3.utils.fromWei(fee)} ETH to use. You can
								pay below. Once you pay, you're Ethereum address will be
								whitelisted for life.
							</Text>
						)}
					</Modal.Body>
					<Modal.Footer>
